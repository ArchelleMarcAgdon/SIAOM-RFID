...
<html lang = "eng">
						...
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								...
								<div class = "form-group">
									...
									<input type = "text" name = "student_idno" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tr>
							...
							<td><?php echo $f_student['student_idno']?></td>
							...
							<td><?php echo $f_student['user_status']?></td>
							<td><?php echo $f_student['time_spent']?></td>
	...
	<script src = "js/sjquery.dataTables.js"></script>
